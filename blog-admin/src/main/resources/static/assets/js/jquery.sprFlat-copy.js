...
(function ($) {
  ...
  // here we go!
  $.sprFlatCopy = function (element, options) {
    ...
    //       if (hw <= actualWidht) {
    //         $('#header-area>.header-area-inner>.list-unstyled').css('width',
    //             actualWidht);
    //       }
    ...
    plugin.sideBarNav = function () {
        ...
        if (plugin.settings.sideNav.showNotificationNumbers == 'always') {
          navSub.each(function () {
            ...
            if (!$(this).prev('a').find('span.notification').length) {
              $(this).prev('a').append('<span class="notification '
                  + plugin.settings.sideNav.notificationColor + '">' + subItems
                  + '</span>');
            }
          })
        } else {
          navSub.each(function () {
            subItems = $(this).find('li').length;
            if (!$(this).prev('a').find('span.notification').length) {
              $(this).prev('a').append('<span class="notification onhover '
                  + plugin.settings.sideNav.notificationColor + '">' + subItems
                  + '</span>');
            }
          })
      ...
      if (plugin.settings.sideNav.showArrows) {
        ...
        if (!navSub.prev('a').find('i.sideNav-arrow').length) {
          navSub.prev('a').prepend('<i class="'
              + plugin.settings.sideNav.sideNavArrowIcon
              + ' sideNav-arrow"></i>');
        }
      }
      ...
      navLink.hover(
          function () {
            //in
            if (plugin.settings.sideNav.showIndicator) {
              $(this).find('.indicator').transition({opacity: 1}, 50);
            }
          },
          function () {
            //out
            if (plugin.settings.sideNav.showIndicator) {
              $(this).find('.indicator').transition({opacity: 0}, 0);
            }
          }
      );
          ...
          function () {
            ...
            if (plugin.settings.sideNav.hover) {
              if (_this.hasClass('notExpand')) {
                _this.next('ul').slideDown(plugin.settings.sideNav.subOpenSpeed,
                    plugin.settings.sideNav.animationEasing);
          ...
          function () {
            ...
            if (plugin.settings.sideNav.hover) {
              if (_this.hasClass('expand')) {
                ...
                _this.next('ul').slideUp(plugin.settings.sideNav.subCloseSpeed,
                    plugin.settings.sideNav.animationEasing);
    ...
    plugin.panels = function () {
      ...
      panels.each(function (index) {
        ...
        if (self.hasClass('toggle') || self.hasClass('panelClose')
            || self.hasClass('panelRefresh')) {
        ...
        //refresh
        if (self.hasClass('panelRefresh') && !panelControls.find(
                'a.panel-refresh').length) {
          panelControls.append('<a href="#" class="panel-refresh"><i class="'
              + plugin.settings.panels.refreshIcon + '"></i></a>');
        }
        //Toggle
        if (self.hasClass('toggle') && !panelControls.find('a.toggle').length) {
          if (self.hasClass('panel-closed')) {
            panelControls.append('<a href="#" class="toggle panel-maximize"><i class="'
                + plugin.settings.panels.collapseIcon + '"></i></a>');
            self.find('.panel-body').slideToggle(0);
            self.find('.panel-footer').slideToggle(0);
            self.find('.panel-heading').toggleClass('min');
          } else {
            panelControls.append('<a href="#" class="toggle panel-minimize"><i class="'
                + plugin.settings.panels.toggleIcon + '"></i></a>');
          }
        }
        //close
        if (self.hasClass('panelClose') && !panelControls.find(
                'a.panel-close').length) {
          panelControls.append('<a href="#" class="panel-close"><i class="'
              + plugin.settings.panels.closeIcon + '"></i></a>');
        }
      ...
      if (plugin.settings.panels.showControlsOnHover) {
        ...
        panels.hover(
            function () {
              //in
              if ($(this).find('.panel-controls').hasClass(
                      'panel-controls-hide')) {
      ...
      panelControlsLink.click(function (e) {
        ...
        if (self.hasClass('toggle')) {
          ...
          thisIcon.toggleClass(plugin.settings.panels.toggleIcon + ' '
              + plugin.settings.panels.collapseIcon);
        ...
        if (self.hasClass('panel-refresh')) {
          ...
          thisPanel.append('<div class="progress-loader"><i class="'
              + plugin.settings.panels.overlayRefreshIcon
              + ' icon-spin"></i></div>');
    ...
    plugin.chatWindow = function () {
      ...
      function appendMsg(msg) {
        $('.chat-box .chat-messages').append('<li class="chat-me"><p class="avatar"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/roybarberuk/48.jpg" alt="SuggeElson"></p><p class="chat-name">SuggeElson <span class="chat-time">Now</span></p><p class="chat-txt">'
            + msg + '</p></li>');
      }
    }
      ...
      (function (e) {
        e.fn.goup = function (t) {
          ...
          return this.each(function () {
            ...
            if (n.place === "top-right") {
              t.css({
                top: n.marginY + "%",
                right: n.marginX + "%"
              });
            } else if (n.place === "top-left") {
              t.css(
                  {top: n.marginY + "%", left: n.marginX + "%"});
            } else if (n.place
                === "bottom-right") {
              t.css({
                bottom: n.marginY + "%",
            ...
            } else if (n.place === "bottom-left") {
              t.css(
                  {bottom: n.marginY + "%", left: n.marginX + "%"});
            } else {
              t.css(
                  {bottom: n.marginY + "%", right: n.marginX + "%"})
            }
          })
        }
      })(jQuery);
    ...
    plugin.storejs = function () {
      ...
      (function (e) {
        ...
        t.disabled = !1, t.set = function (e, t) {
          ...
          var i = t.get(e);
          r == null && (r = n, n = null), typeof i == "undefined" && (i = n
              || {}), r(i), t.set(e, i)
        }, t.getAll = function () {
        }, t.forEach = function () {
        ...
        if (o()) {
          s = e[r], t.set = function (e, n) {
            return n === undefined ? t.remove(e) : (s.setItem(e,
                t.serialize(n)), n)
          }, t.get = function (e) {
          ...
          try {
            a = new ActiveXObject("htmlfile"), a.open(), a.write("<" + i
                + ">document.w=window</" + i
                + '><iframe src="/favicon.ico"></iframe>'), a.close(), u = a.w.frames[0].document, s = u.createElement(
                "div")
          } catch (f) {
          ...
          function l(e) {
            return function () {
              ...
              n.unshift(s), u.appendChild(s), s.addBehavior(
                  "#default#userData"), s.load(r);
              var i = e.apply(t, n);
          ...
          t.set = l(function (e, n, i) {
            return n = h(n), i === undefined ? t.remove(n) : (e.setAttribute(n,
                t.serialize(i)), e.save(r), i)
            ...
            for (var i = 0, s; s = r[i]; ++i) {
              n(s.name,
                  t.deserialize(e.getAttribute(s.name)))
            }
          })
        }
        try {
        ...
        && this.module !== module ? module.exports = t : typeof define
        == "function" && define.amd ? define(t) : e.store = t
      ...
      (function (k) {
        ...
        j.prototype = {
          setFromString: function (t, s) {
            var r = (typeof s === "string") ? s.split(",") : (s.constructor
                === Array) ? s : [s];
            r.unshift(t);
            ...
            for (var r in this) {
              if (this.hasOwnProperty(r)) {
                if ((!q.transform3d) && ((r === "rotateX") || (r === "rotateY")
                        || (r === "perspective") || (r
                            === "transformOrigin"))) {
                  continue
                }
      ...
      (function ($) {
        ...
        $.event.special.mousewheel = {
          setup: function () {
            if (this.addEventListener) {
              for (var i = types.length;
                  i;) {
                this.addEventListener(types[--i], handler,
                    false);
              }
            } else {
            ...
            if (this.removeEventListener) {
              for (var i = types.length;
                  i;) {
                this.removeEventListener(types[--i], handler,
                    false);
              }
            } else {
        ...
        function handler(event) {
          var orgEvent = event || window.event,
              args = [].slice.call(arguments, 1), delta = 0, returnValue = true,
              deltaX = 0, deltaY = 0;
    ...
    plugin.hoverDirection = function () {
      ...
      !function (a) {
        ...
        function c(c) {
          var d = a(this), e = d.height(), f = d.width(),
              g = (c.pageX - d.offset().left - f / 2) * (f > e ? e / f : 1),
              h = (c.pageY - d.offset().top - e / 2) * (e > f ? f / e : 1),
              i = Math.round((Math.atan2(h, g) * (180 / Math.PI) + 180) / 90
                  + 3) % 4, k = j.cssPrefix,
              l = "mouseleave" === c.type ? "leave" : "enter", m = b(i);
          return k + "-" + l + "-" + m
        }

        function d(b) {
          var d = c.apply(this, [b]);
          a(this).addClass(d)
        }
        ...
        function f(a) {
          e.apply(this), d.apply(this, [a])
        }

        var g, h = "hoverDirection", i = {cssPrefix: "hover"}, j = {}, k = {
          init: function (b) {
            return j = a.extend(i, b), g = new RegExp("\\" + j.cssPrefix
                + "\\S+", "g"), this.each(function () {
              a(this).on("mouseenter mouseleave", f)
            })
          }, removeClass: function () {
            return e.apply(this), this
          }, destroy: function () {
            return e.apply(this), this.each(function () {
              a(this).off("mouseenter mouseleave", f)
            })
          }
        };
        a.fn[h] = function (b) {
          return k[b] ? k[b].apply(this,
              Array.prototype.slice.call(arguments, 1)) : "object" != typeof b
          && b ? void a.error("Method " + b + " does not exist on jQuery." + h)
              : k.init.apply(this)
        }
      }(jQuery, window, document);
    }
    ...
    plugin.quickSearch = function () {
      ...
      if ($('.todo-search input').length) {
        $('.todo-search input').val('').quicksearch(
            '.todo-list .todo-task-item');
      }

      //quick search on recent-users widget
      if ($('.users-search input').length) {
        $('.users-search input').val('').quicksearch(
            '.recent-users-widget .list-group-item');
      }
    ...
    plugin.expandSideBarNav = function () {
      ...
      nava.next('ul').slideDown(plugin.settings.sideNav.subOpenSpeed,
          plugin.settings.sideNav.animationEasing);
    ...
    plugin.collapseSideBarNav = function () {
      ...
      nava.next('ul').slideUp(plugin.settings.sideNav.subOpenSpeed,
          plugin.settings.sideNav.animationEasing);
    ...
    plugin.retinaReady = function () {
      !function () {
        ...
        function c(a, c) {
          if (this.path = a || "", "undefined" != typeof c && null
              !== c) {
            this.at_2x_path = c, this.perform_check = !1;
          } else {
            if (void 0 !== document.createElement) {
              var d = document.createElement("a");
              d.href = this.path, d.pathname = d.pathname.replace(g,
                  b), this.at_2x_path = d.href
            } else {
        ...
        function d(a) {
          this.el = a, this.path = new c(this.el.getAttribute("src"),
        ...
        e.Retina = a, a.configure = function (a) {
          ...
          return e.devicePixelRatio > 1 ? !0 : e.matchMedia && e.matchMedia(
              a).matches ? !0 : !1
        };
        var g = /\.\w+$/;
        e.RetinaImagePath = c, c.confirmed_paths = [], c.prototype.is_external = function () {
          ...
          var b, d = this;
          return this.is_external() ? a(!1) : this.perform_check || "undefined"
          == typeof this.at_2x_path || null === this.at_2x_path
              ? this.at_2x_path in c.confirmed_paths ? a(!0)
                  : (b = new XMLHttpRequest, b.open("HEAD",
                      this.at_2x_path), b.onreadystatechange = function () {
                    if (4 !== b.readyState) {
                      return a(!1);
                    }
          ...
          function b() {
            c.el.complete ? (f.force_original_dimensions && (c.el.setAttribute(
                "width", c.el.offsetWidth), c.el.setAttribute("height",
                c.el.offsetHeight)), c.el.setAttribute("src", a)) : setTimeout(
                b, 5)
          }
