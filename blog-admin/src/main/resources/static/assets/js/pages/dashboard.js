...
$(document).ready(function () {
  ...
  $(function () {
    ...
    var data = [["JAN", 1500], ["FEB", 1345], ["MAR", 1800], ["APR", 1670],
      ["MAY", 1780], ["JUN", 1500], ["JUL", 1350], ["AUG", 1700], ["SEP", 1890],
      ["OCT", 2000], ["NOV", 1950], ["DEC", 2000]];
  ...
  $(function () {
    var options = {
      ...
      legend: {
        show: true,
        labelFormatter: function (label, series) {
          return '<div style="font-weight:bold;font-size:13px;">' + label
              + '</div>'
        },
        labelBoxBorderColor: null,
        margin: 50,
  ...
  $(function () {
    ...
    var d1 = [["MON", randNum()], ["TUE", randNum()], ["WED", randNum()],
      ["THU", randNum()], ["FRI", randNum()], ["SAT", randNum()],
      ["SUN", randNum()]];
  ...
  //------------- Init pie charts -------------//
  initPieChartDashboard(10, 40, 1500, colours);

});

//Setup easy pie charts in sidebar
var initPieChartDashboard = function (lineWidth, size, animateTime, colours) {
