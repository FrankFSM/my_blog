    ...
    Editor.prototype = {
        ...
        _initDom: function _initDom() {
            ...
            if (textSelector == null) {
                ...
                $textContainerElem.css("border", "1px solid #009a61").css("border-radius", "0px 0px 15px 0px").css("height", "100%").css("min-height","115px");
            } else {
                // toolbar 和 text 的选择器都有值，记录属性
                $toolbarElem = $toolbarSelector;
                $textContainerElem = $(textSelector);ss
                // 将编辑器区域原有的内容，暂存起来
...
window.wangEditor.fullscreen = {
    init: function(editorSelector) {
        $(editorSelector + " .w-e-toolbar").append('<div class="w-e-menu"><a class="_wangEditor_btn_fullscreen" href="###" onclick="window.wangEditor.fullscreen.toggleFullscreen(\'' + editorSelector + '\')" data-toggle="tooltip" data-placement="bottom" title data-original-title="全屏编辑"><i class="im-expand"></i></a></div>')
    },
